defmodule SlackexWeb.AuthLive.Register do
  ...
  def render(assigns) do
    ~H"""
    <div class={[@loom && "loom min-h-screen flex items-center justify-center px-4"]}>
      <div class="mx-auto max-w-sm mt-10 w-full">
        <h1 class="loom-auth-title text-2xl font-bold mb-6 text-center">Create an account</h1>
