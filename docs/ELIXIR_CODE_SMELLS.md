...
*Added 2026-07-26; written 2026-06-14.* Condensed from Lucas Vegi's PhD thesis *"Code Smells and Refactorings for Elixir"* (Vegi & Valente, UFMG). Source catalogs: <https://github.com/lucasvegi/Elixir-Code-Smells> and <https://github.com/lucasvegi/Elixir-Refactorings>.
